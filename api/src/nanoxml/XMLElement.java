 ...
 * Enumeration e = element.getAttributeNames();<BR>
 ...
 * <P>
 *
 * <p><B>NOTE</B> - This class has been modifed by Bob Marks (marksie531@yahoo.com)
 * to include indentation support.</p>
 *
...
public class XMLElement
{
    ...
    public XMLElement()
    {
        // NOTE: Changes by Bob Marks to ensure case isn't ignored
        this(new Hashtable(), false, true, false);
    }
    
    /**
     * Constructor which takes a name and also sets ignoreCase to false. 
     * 
     * @author Bob Marks
     * @param name
     */
    ...
    /**
     * Writes the XML element to a string with the option of indentation.
     *
    ...
    /**
     * Writes the XML element to a writer with indentation.
     * 
     * Note: updated to show indentation.
     * 
     * @param writer
     *     The writer to write the XML data to.
     * @param indent
     *     If -1 then do not indent.
     *
     * </dl><dl><dt><b>Preconditions:</b></dt><dd>
     ...
     */
    protected void write(Writer writer, int indent)
        throws IOException
    {
        if (this.name == null) {
