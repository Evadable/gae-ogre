 ...
 * @version Beta 0.3
 */
public class CommChatClient extends CommGameMessage {

	/** Chat String. */
	protected String chat;

	/**
	 * Constructer for a client message which is sent to everyone.
	 *
	 * @param chat    Chat message from user.
	 */
	public CommChatClient (String chat) {
	    super ();
	 ...
	 */
	public CommChatClient (XMLElement message) throws TransmissionException {
	    super (message);
