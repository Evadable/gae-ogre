 ...
 * @version Alpha 0.2.3
 */
public class CommExitTable extends CommTableMessage {
    ...
    /**
     * Constructor which the server informs clients that a user
     * has left a table.
     *
     * @param username
     */
    public CommExitTable (int tableNum, String username) {
        super (username);
	...
	public XMLElement flatten () {
		return super.flatten (Comm.EXIT_TABLE);
	}
}