 ...
 * that make a hexagon shape.</p>
 *
 * <p>Hexagon boards look like this:
 * <pre>
 *  .     .     *     .     .
 *     .     *     *     .
 *  .     *     *     *     .
 ...
 * shown with .'s.  (This is a hexagon of size=5.)</p>
 *
 ...
 * @version Beta 0.3
 */
public abstract class AbstractHexagonHexBoardComponent extends AbstractPartialHexBoardComponent {

	/**
	 * Constructor for a Hexagonal board.
	 *
	 ...
	 */
	public AbstractHexagonHexBoardComponent (
		int sideSize,
		Dimension cellDim,
	 ...
	 * hexagon shape with sides of the given length (in hexagons).
	 *
	 * @param size          The number of hexagons on each side of the hexagon.
	...
	public static boolean [][] makeExistsArray(int size) {
		...
		HexBoardUtils.fillHexTriangle(theArray, size-1, 0, numCols, size, false, true);
		HexBoardUtils.fillHexTriangle(theArray, size-1, 0, numCols, size, true, true);
