 ...
 * @version Beta 0.3
 */
public class CommAdminDataMessage extends CommGameMessage {
	 ...
	 * @param message
	 */
	public CommAdminDataMessage (String gameID, String username, XMLElement message) {
		super (username);		
	 ...
	 */
	public CommAdminDataMessage (XMLElement message) {
		super (message);
