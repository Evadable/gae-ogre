filename=%game_id%/build.xml
<?xml version="1.0" encoding="utf-8"?>
<!--
===============================================================================
Ant build script for Jogre %Game_id% - %Version%
===============================================================================
-->

<project name="JOGRE %Game_id%" default="compile" basedir=".">

    <description>
        This is the build file for JOGRE %Game_id%
    </description>
    ...
    <property name="jar.file"   value="applet_%game_id%.jar"/>
