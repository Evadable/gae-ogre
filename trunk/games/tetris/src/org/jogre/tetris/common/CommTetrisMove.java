...
/**
 * Communication object for transmitting a tetris move.
 *
 * @author Bob Marks
 * @version Alpha 0.2.3
 */
public class CommTetrisMove extends CommTableMessage {
    ...
    public  static final String XML_NAME           = "tetris_move";
     ...
     */
    public CommTetrisMove(int seatNum,
                          int curShapeNum, 
                          int curShapePos, 
                          int curShapeX, 
                          int curShapeY, 
     ...
     * @param message
     */
    public CommTetrisMove (XMLElement message) {
        super (message);
