...
import org.jogre.carTricks.server.CarTricksServerModel;

/**
 * Test model for the Car Tricks server model.
 *
 ...
 * @version Beta 0.3
 */
public class CarTricksServerTestModel extends CarTricksServerModel {

	// Constructor
	public CarTricksServerTestModel (int numPlayers, CarTricksTrackDB trackDatabase, boolean enableEventCards) {
		super (numPlayers, trackDatabase, enableEventCards);
	}
