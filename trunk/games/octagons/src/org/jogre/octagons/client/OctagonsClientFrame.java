...
// Octagons client frame.
public class OctagonsClientFrame extends JogreClientFrame {

  // Constructor
  public OctagonsClientFrame (String [] args) {
	super (args);
  }
  ...
  public static void main (String [] args) {
    OctagonsClientFrame frame = new OctagonsClientFrame (args);
  }   
}
