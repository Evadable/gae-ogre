 ...
 * @version Alpha 0.2.3
 */
public class HexClientFrame extends JogreClientFrame {

	/**
	 * Constructor for the client frame.
	 */
	public HexClientFrame (String [] args) {
		super (args, true);
	}
	...
	public void getPropertyDialog(ClientConnectionThread conn) {
		...
		new HexPropertyDialog(this, label, conn);
	}
	...
	public static void main (String [] args) {
		HexClientFrame frame = new HexClientFrame (args);
	}
}
