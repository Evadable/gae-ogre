filename=%game_id%/game_labels.properties
#=============================================================================
...
# Client
game.label=%Game_id%
jogre.client.title=Jogre %Game_id% Client
jogre.client.welcome.message=Welcome to Jogre %Game_id%!
jogre.table.title=Jogre %Game_id% Table

# Must be a "player.label.0" to "player.label.x" 
# where x = max.num.players - 1 (from game.properties)
player.label.0=White
player.label.1=Black