 ...
 *
 */
public class ChessClientFrame extends JogreClientFrame {
     ...
     * @param args
     */
    public ChessClientFrame (String [] args) {
        super (args);
    }
    ...
    public JogreTableFrame getJogreTableFrame (TableConnectionThread conn) {
        return new ChessTableFrame (conn);
    }
	...
	public static void main (String [] args) {
		ChessClientFrame client = new ChessClientFrame (args);
	}
}