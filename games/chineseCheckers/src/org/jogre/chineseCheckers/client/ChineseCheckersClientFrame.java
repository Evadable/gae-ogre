...
/**
 * Chinese Checkers client frame.
 *
 * @author Richard Walter
 * @version Alpha 0.2.3
 */
public class ChineseCheckersClientFrame extends JogreClientFrame {

	/**
	 * Constructor for the client frame.
	 */
	public ChineseCheckersClientFrame (String [] args) {
		super (args, true);
	}

	/**
	 * Retur the correct table frame.
	 */
	...
	public void getPropertyDialog(ClientConnectionThread conn) {
		...
		new ChineseCheckersPropertyDialog (this, label, true, conn);
	}
	...
	public static void main (String [] args) {
		ChineseCheckersClientFrame frame = new ChineseCheckersClientFrame (args);
	}
}
