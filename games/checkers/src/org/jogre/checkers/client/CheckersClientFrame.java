...
/**
 * Checkers Client Frame.
 *
 * @author  Bob Marks
 * @version Alpha 0.2.3
 */
public class CheckersClientFrame extends JogreClientFrame {
	 ...
	 * @param title
	 */
	public CheckersClientFrame (String [] args) {
		super (args);
	}

	/**
	 * Return checkers table frame.
	 *
	...
	public JogreTableFrame getJogreTableFrame (TableConnectionThread conn) {
		// Return checkers table frame
		return new CheckersTableFrame (conn);
	}
