...
/**
 * Applet class for PointsTotal.
 *
 * @author  Richard Walter
 * @version Beta 0.3
 */
public class PointsTotalApplet extends JogreClientApplet {

    /**
     * Applet constructor for a game of pointsTotal.
     *
     * @param conn
     * @param tableNum
     */
    public PointsTotalApplet () {
        super (true);
    }
