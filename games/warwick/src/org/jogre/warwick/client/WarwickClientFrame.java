...
/**
 * Game client frame for a game of warwick.  This is the
 * entry point to the game as an application.
 *
 * @author  Richard Walter
 * @version Beta 0.3
 */
public class WarwickClientFrame extends JogreClientFrame {
	 ...
	 */
	public WarwickClientFrame (String [] args) {
		super (args, true);
	}
	...
	/**
	 * Main method which executes a game of warwick.
	 *
	 * @param args
	 */
	public static void main (String [] args) {
		WarwickClientFrame client = new WarwickClientFrame (args);
	}
}
